...
5. **Open your web browser and navigate to:**
    ...
    ```
    http://127.0.0.1:8000/myall/create  # for question 1 and 2
    http://127.0.0.1:8000/myall/create3 # for question 3
    ```

    output will displays on the terminal


or instead of using uv for package managing , pip with virtualenv also will  works fine
